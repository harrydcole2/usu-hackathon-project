      ...
      <div className="flex flex-col min-h-screen overflow-hidden bg-gradient-to-b from-[#C9D6EA] to-[#E8F7EE] relative">
        ...
        >
          ...
          <p className=" p-6 mb-8 text-xl md:text-2xl text-gray-700 leading-relaxed bg-white/80 backdrop-blur-sm rounded-2xl shadow-md ">
            Welcome to the Pantry! We help you track your food, alert you before
          ...
          {[
            {
              ...
              description:
                "Keep tabs on everything in your fridge and pantry with ease.",
              icon: "🧊",
            ...
            },
            {
              title: "Smart Recipes",
              description:
                "Generate meal plans based on what you already have.",
              icon: "👨‍🍳",
            ...
            >
              <div
                className={`bg-gradient-to-r ${feature.color} p-4 text-center`}
              >
